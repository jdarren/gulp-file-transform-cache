 ...
 *
 **/
function makeTransformAdapter(stream) {
...
function gulpFileTransformCache(options) {
    ...
    var ftcOptions = _.assign( {}, options, {transforms: [ makeTransformAdapter(options.transformStream) ]});
    delete ftcOptions.transformStream;
